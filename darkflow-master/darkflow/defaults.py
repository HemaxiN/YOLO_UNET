class argHandler(dict):
    ...
    def setDefaults(self):
        #self.define('imgdir', 'D:/Ambiente_de_Trabalho/Tese/working/Article/test_time/allimages/', 'path to testing directory with images')
        self.define('imgdir', 'D:/Ambiente_de_Trabalho/Tese/working/Article/IMAGEM/', 'path to testing directory with images')
        ...
        self.define('labels', 'onelabel.txt', 'path to labels file')
        ...
        self.define('model', 'cfg/tiny-yoloc1_1024.cfg', 'configuration of choice')
